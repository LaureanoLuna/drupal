...
/* themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--overlay.html.twig */
class __TwigTemplate_3ffb14de72246938f52d6f69c51bb2b9 extends Template
{
    private $source;
    private $macros = [];
...
$context["item"], "is_expanded", [], "any", false, false, true, 46) && (($context["menu_level"] ?? null) == 0))) ? ("mb-accordion__section") : (""))];
        ...
        ";
          ...
          ";
              ...
              ";
                        // line 55
                        $this->loadTemplate("@material_base/components/01_atoms/icon.twig", "themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--overlay.html.twig", 55)->display(twig_array_merge($context, ["data" => ["value" => "arrow_drop_down"], "settings" => ["type" => "svg-sprite"]]));
                        // line 63
                        echo "            </span>
          ";
                    }
...
$context["item"], "is_expanded", [], "any", false, false, true, 68) && (($context["menu_level"] ?? null) == 0))) ? ("mb-accordion__section-toggle") : (""))];
  ...
  ";
    ...
    {
        return "themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--overlay.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--overlay.html.twig", "C:\\xampp\\htdocs\\drupal\\web\\themes\\contrib\\material_base\\themes\\material_base_mdc\\templates\\navigation\\menu--overlay.html.twig");
    }
