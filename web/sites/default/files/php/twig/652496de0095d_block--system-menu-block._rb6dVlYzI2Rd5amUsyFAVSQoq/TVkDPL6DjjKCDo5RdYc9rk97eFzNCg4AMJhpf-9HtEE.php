...
class __TwigTemplate_1c97f47a208421fd414dee85e77b1c51 extends Template
{
    private $source;
    private $macros = [];
...
($context["derivative_plugin_id"] ?? null), 40, $this->source)))];
  ...
  <h2";
        // line 50
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "block-title"], "method", false, false, true, 50), "setAttribute", [0 => "id", 1 => ($context["heading_id"] ?? null)], "method", false, false, true, 50), 50, $this->source), "html", null, true);
        echo ">";
...
";
  ...
  ";
    ...
    {
        return array (  85 => 53,  81 => 52,  76 => 55,  74 => 52,  70 => 51,  64 => 50,  59 => 49,  56 => 48,  53 => 47,  50 => 46,  45 => 44,  43 => 43,  41 => 40,  40 => 36,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/contrib/tara/templates/block/block--system-menu-block.html.twig", "C:\\xampp\\htdocs\\drupal\\web\\themes\\contrib\\tara\\templates\\block\\block--system-menu-block.html.twig");
    }
