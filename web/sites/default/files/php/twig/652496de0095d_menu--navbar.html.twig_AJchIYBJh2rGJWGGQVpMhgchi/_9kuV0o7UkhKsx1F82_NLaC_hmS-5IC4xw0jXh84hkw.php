...
/* themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--navbar.html.twig */
class __TwigTemplate_2805e28c55efbaf9776b4fd9cd03cc8c extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
          ...
          ";
                    ...
                    if ((twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 55) && (($context["menu_level"] ?? null) == 0))) {
                        // line 56
                        echo "            ";
                        $this->loadTemplate("@material_base/components/01_atoms/icon.twig", "themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--navbar.html.twig", 56)->display(twig_array_merge($context, ["data" => ["value" => "arrow_drop_down"], "settings" => ["type" => "svg-sprite", "classes" => [0 => "navbar-menu__item-icon"]]]));
                        // line 65
                        echo "          ";
                    }
                    // line 66
...
($context["menu_level"] ?? null) == 1)) ? ("mdc-deprecated-list-item") : (""))];
    ...
    {
        return "themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--navbar.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/material_base/themes/material_base_mdc/templates/navigation/menu--navbar.html.twig", "C:\\xampp\\htdocs\\drupal\\web\\themes\\contrib\\material_base\\themes\\material_base_mdc\\templates\\navigation\\menu--navbar.html.twig");
    }
