...
class __TwigTemplate_083a55cbf25916915403ca0a194c8d25 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal\\web\\themes\\contrib\\bootstrap_barrio\\templates\\content-edit\\filter-tips.html.twig");
    }
